  ...
  return (
    <section className="bg-white py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="bg-brand-blue-dark shadow-brand-blue-dark/20 relative overflow-hidden rounded-[2rem] px-6 py-14 text-white shadow-2xl sm:px-12 lg:px-16 lg:py-16">
          <div
            aria-hidden="true"
            className="bg-brand-blue/40 absolute -end-20 -top-20 size-64 rounded-full blur-3xl"
          />

          <div
            aria-hidden="true"
            className="bg-brand-green/30 absolute -start-24 -bottom-32 size-72 rounded-full blur-3xl"
          />
